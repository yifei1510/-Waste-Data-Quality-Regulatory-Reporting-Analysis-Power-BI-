...
However, raw waste datasets often contain:

Inconsistent financial year formats

Non-standardised jurisdiction/state naming

Mixed units of measurement (kg vs tonnes)

Variations that are difficult to interpret without structured analysis
...
Data structure reflects real-world regulatory reporting challenges, rather than simplified or academic datasets
...
Resolved inconsistent jurisdiction/state naming conventions
...
Performed basic input–output alignment checks to support mass balance readiness
...
Created interactive dashboards to explore waste flows by:
...
Power Query: Data cleaning, transformation, standardisation

DAX: KPI measures, year-on-year comparisons, percentage calculations

Data Quality Management: Validation, consistency checks, anomaly identification
...
Enabled faster comparison of waste trends across years, categories, and jurisdictions

Improved clarity and transparency through decision-focused KPI dashboards
...
No enforcement or compliance conclusions are drawn
...
Deeper mass balance calculations at category or facility level

Integration with compliance or inspection datasets

Automated anomaly detection thresholds for ongoing monitoring
